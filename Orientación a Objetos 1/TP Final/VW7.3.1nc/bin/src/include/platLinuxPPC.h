/* SccsId is @(#)platLinuxPPC.h	58.10 04/06/05 */
/************************************************************************
 * File: platLinuxPPC.h
 *
 * This file contains the platform-dependent definitions for the PowerPC chip
...
register void *edenAllocAndLimitRegister asm("r26");
#endif
 ...
 */
#define GlueProc "glueLinuxPPC.h"

/* I/O defines */
#define PLAT_OSNAME "unix sysV PowerPC linux"
